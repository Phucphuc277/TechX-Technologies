const products = [
    { name: "POP Mouse", id: "pop-mouse" },
    { name: "Ergo M575s", id: "ergo-m575s" },
    { name: "K369 PoSe", id: "k369-pose" },
    { name: "Signature Pouse M980", id: "signature-pouse-m980" },
    { name: "MN Medical", id: "mn-medical" },
    { name: "Pebble M2 K380s", id: "pebble-m2-k380s" }
];
        ...
        li.onclick = () => {
            ...
            if (targetElement) {
                ...
                if (productNameElement) {
                    ...
                    setTimeout(() => {
                        productNameElement.style.color = "black";
                    }, 3000);
                }
            }
        };
